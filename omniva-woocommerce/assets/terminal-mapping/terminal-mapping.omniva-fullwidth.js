/* Generated by scripts/package-theme.sh; theme: omniva-fullwidth. */
/******/ (() => { // webpackBootstrap
/******/ 	"use strict";
...
(function (global) {
  ...
  function scheduleMapResize(tmjs) {
    ...
    if (state) {
      ...
      tmjs.sub('modal-opened', function () {
        ...
        if (activeLocation) {
          ...
          // the active marker. Keep the existing popup in place instead.
          if (
            !existingPopupIsOpen
            && typeof tmjs.map.openActivePopup === 'function'
          ) {
            // The view may already have emitted moveend before the popup
            // helper registers its listener when reopening the modal.
            tmjs.map.openActivePopup(true);
          }
        }
