...
var DOMManipulator = /*#__PURE__*/function () {
  ...
  _createClass(DOMManipulator, [{
    ...
    value: function setActiveTerminal(id) {
      ...
      if (!skipMapZoom && this.UI.modal && !this.UI.modal.classList.contains('tmjs-hidden')) {
        if (typeof this.TMJS.map.zoomToMarker === 'function') {
          this.TMJS.map.zoomToMarker(location._marker);
        } else if (this.TMJS.map._map) {
    ...
    value: function markerPopUpInfo(e) {
      ...
      if (typeof e.options.terminalId !== 'undefined') {
        ...
        if (location) {
          ...
          // A focused map location is not necessarily the terminal selected for checkout.
          var isSelected = selectedTerminalId !== '' && selectedTerminalId === String(location.id);
